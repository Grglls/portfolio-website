...
const carouselState = {
  ...
  "project-2-planning": {
    "slideIndex": 1,
    "slides": document.querySelectorAll("#project-2-planning .mySlides"),
    "dots": document.querySelectorAll("#project-2-planning .dot")
  },
  "project-3": {
    "slideIndex": 1,
  ...
  "project-3-planning": {
    "slideIndex": 1,
    "slides": document.querySelectorAll("#project-3-planning .mySlides"),
    "dots": document.querySelectorAll("#project-3-planning .dot")
  },
  "project-4": {
    "slideIndex": 1,
    "slides": document.querySelectorAll("#project-4 .mySlides"),
    "dots": document.querySelectorAll("#project-4 .dot")
  },
  "project-4-planning": {
    "slideIndex": 1,
    "slides": document.querySelectorAll("#project-4-planning .mySlides"),
    "dots": document.querySelectorAll("#project-4-planning .dot")
  }
};
showSlides();
